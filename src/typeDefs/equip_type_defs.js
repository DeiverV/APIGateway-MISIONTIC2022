...
const equipTypeDefs = gql `
    ...
    extend type Mutation{
        newRegister(registerInput: Register!):RegisterGet!
        newUsuario(usuarioInput: Usuarios!):UsuariosGet!
        newContabilidad(contabilidadInput: Contabilidad!):ContabilidadGet!
        newSoftware(softwareInput: Software!):SoftwareGet!
    }
